...
namespace MultipleBotFramework.Db.Migrations
{
    ...
    [Migration("20241126210044_AddPropertiesToChatHistoryTable")]
    partial class AddPropertiesToChatHistoryTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MultipleBotFramework.Db.Entity.BotChatHistoryEntity", b =>
                {
                    ...
                    b.Property<string>("InlineKeyboard")
                        .HasColumnType("text")
                        .HasColumnName("inline_keyboard")
                        .HasComment("JSON представление inline клавиатуры сообщения.");
                    ...
                    b.Property<string>("ReplyKeyboard")
                        .HasColumnType("text")
                        .HasColumnName("reply_keyboard")
                        .HasComment("JSON представление клавиатуры пользователя.");

                    b.Property<long?>("ReplyToMessageId")
                        .HasColumnType("bigint")
                        .HasColumnName("reply_to_message_id")
                        .HasComment("Ответ на сообщение. ИД сообщения, на которое отвечаем. Telegram идентификатор.");
            ...
            modelBuilder.Entity("MultipleBotFramework.Db.Entity.BotUpdateEntity", b =>
                {
                    ...
                    b.Property<long?>("UserId")
                        ...
                        .HasComment("Внешний ключ на таблицу пользователей.");
                    ...
                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_updates_user_id");
            ...
            modelBuilder.Entity("MultipleBotFramework.Db.Entity.BotUpdateEntity", b =>
                {
                    ...
                    b.HasOne("MultipleBotFramework.Db.Entity.BotUserEntity", "User")
                        ...
                        .HasConstraintName("fk_updates_users_user_id");
